...
//     description:
//       "The Notes Management System in PHP is a simple application that facilitates users in uploading, downloading, and managing notes for their respective courses.",
...
//     description:
//       "Developed a convolutional neural network (CNN) model to classify brain tumor images obtained from MRI scans. Implemented data preprocessing techniques and trained the model to accurately classify tumors into different categories.",
...
//               Academic Projects
//             </h3>
//             {projects.map(({ title, duration, description, role }) => (
      ...
      <div className="flex flex-wrap lg:flex-nowrap gap-10 justify-center">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="p-6 shadow-md bg-white rounded-xl border border-gray-200 mt-10">
            ...
            <a
              href="https://drive.google.com/file/d/1uTuxgBK1MJaTbVF9hFtPXq_NSQKleT-Z/view" // Replace with your actual Google Drive link
              target="_blank"
